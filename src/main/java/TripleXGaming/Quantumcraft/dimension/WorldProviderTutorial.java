...
{
//this.worldChunkMgr = new WorldChunkManagerHell(Quantumcraft.blackForest, this.dimensionId);
this.worldChunkMgr = new WorldChunkManagerHell(Quantumcraft.blackForest, this.dimensionId);
this.dimensionId = Quantumcraft.BlackForestId;
this.hasNoSky = true;
}
