...
public class MyCustomItemSlab extends ItemBlock{
        ...
        {
         super(block);
         this.singleSlab = (BlockSlab) QCCoreBlocks.Void_BrickSlab; //Here you have to set your single slab
         this.doubleSlab = (BlockSlab) QCCoreBlocks.Void_BrickDoubleSlab; //And here your double slab
